...
- 2026-05-20 (저녁) — **2차 보고 완료** ([yoy-decline-summary-2024-2026.md](../projects/20260520-yoy-decline-segment-analysis/yoy-decline-summary-2024-2026.md)). 사용자 요청 "2024년 기준 3개년 YoY" 로 재집계. 신규 BQ 쿼리 4건 (Q1 베이스 / Q2 카테고리 / Q3 Topic / Q4 월별 시계열) 총 ~5.2 GB. 핵심 발견: APP 매출 -63% = MAU -50% × ARPPU -16%, **iOS 가 Android 보다 빠른 하락(결론 반전)**, iOS ARPPU -21% 가 격차 본질, 점성학 -98% 소멸, 자기탐구 -96% 소멸, 일반운세 청년층 -91% 폭락, 가족자녀 -15% (유일하게 견고). Phase 9 (iOS ARPPU·2026 단기 악화·Topic 미분류 급증·자기탐구 소멸 검증) 신규 후보 등록.
- 2026-05-20 (저녁 추가) — Notion 공유본 생성. 부모: [데이터] 헬로우봇 서비스 매출 분석. URL: https://www.notion.so/366eb34da6e6811180a0ea61b146b0f6
