...
>   - **카카오 선물하기** — ✅ 1차 출시(5/26). 2차 출시 TODO-027 (6/11 이미지 전달 → 6/12 등록 → 6/15 출시) · TODO-029 운영가이드(초안 6/15) · TODO-041 어드민 쿠폰내역 노출 · TODO-013·026 핫픽스 잔여 · TODO-043 굿즈 문의(6/10 회신)
>   - **인프라 잔여** — 🎉 5월 마감 + 비트윈 sub 대부분 완료(019 ✅ 6/5). TODO-005 Azure(6월 내) · TODO-033(6월 중순) · TODO-007 umbrella(033만 남음 → 클로즈 임박) · gcp-gemini(외부)
> **⭐⭐ 높음**: 운영/수익·컴플라이언스 · **⭐ 보통**: 단발 작업·모니터링·분석
> 6/10 수 — **이번 주 = SDK 이관 + 카카오 2차 동시 파도**. ✅ 6/9 TODO-028 데이터 미팅 완료(추천세트 v2 공유) → 후속 TODO-044 · **🔥 6/10(오늘) TODO-043 카카오 회신 추적 + TODO-035 마이그레이션 준비** · 6/11 TODO-027 이미지 전달 · 6/12 TODO-035 백필·캠페인 + TODO-012 개발완료 + TODO-040 스레드 · 6/15 TODO-035 배포 + TODO-027 출시 + TODO-029 초안.
...
| 2 | TODO-027 | ⭐⭐⭐ | 카카오 스킬 교환권 2차 출시 (20종) | 🔥 **6/11 추가 이미지(10종) 전달 → 6/12 지난주 분 포함 20종 일괄 등록 → 6/15 출시**. 추가 10종 스펙·디자인 준비가 핵심 경로 |
...
| # | ID | 중요 | 제목 | 액션 |
|---|----|------|------|------|
| 8 | TODO-005 (Azure) | ⭐⭐⭐ | Azure 계약 이전 | 📅 **6월 내 완료** — MS에 직접 이전 요청서 제출 ✅ → MS 처리 모니터링 |
...
|----|------|------|---------------|--------|--------|------|------|
| TODO-005 | ⭐⭐⭐ | 인프라 계약 (GCP ✅ / Azure ⏳ MS 직접 제출 6/2) | 📅 **6월 내 완료** — 6/2 한국MS 담당자 소통 + MS에 직접 이전 요청서 제출 ✅ → MS 처리 모니터링 | 2026-05-13 | 2026-05-13 | **6월 내** | [상세](todos/TODO-005-infra-contract-monitoring.md) |
