...
| 서버 | **머지 대기** | `feat/popular-chart-ranking` (푸시됨) | `worktrees/hellobot-server` | ✅ 06-11 구현 `7dc5b7bd` + 리뷰 수정 4커밋(`022887d3`~`24bf4350`, tsc 통과)·**PR [#2444](https://github.com/thingsflow/hellobot-server/pull/2444)** — 사용자 검토·머지 대기. 핵클 키 교체 잔여. 피쳐 문서 `docs/features/20260611-home-skill-ranking/` |
