...
> 작성: 2026-06-05 (코디네이터) · 갱신: 2026-06-10 (S5 확정 마커) · 상태: **v3 (기획 피드백 + 현황조사 반영)** · 설계: [architecture.md](architecture.md) · [api-spec.md](api-spec.md)
...
| **FR-B4** | 배치는 **D+1 일배치**로 동작한다(기존 마트 체인 KST 11시 산출과 정합; 기획 '새벽4시'와의 타이밍은 S5에서 조정). ✅ **타이밍 확정(06-10)**: 체인 후행 12:00 KST 적재 + freshness guard — [architecture.md §1.3](architecture.md). | MUST | s3 DF-S3-5 |
