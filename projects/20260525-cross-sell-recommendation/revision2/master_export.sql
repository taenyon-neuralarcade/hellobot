-- REVISION 2 master export — pay_for_% ONLY (pay_under_750 등 마이크로거래 제외)
-- A 앱퍼스트 신규코호트 + 1st/2nd 구매속성 + 30/60/90 윈도우 재구매 플래그 (baseline+transition 통합)
WITH pays AS (
