...
### Phase 5b — 2차 보고: 2024 기준 3개년 YoY (2026-05-20 완료)

사용자 요청 — "2024년 기준으로 하락 판단" + 5세 × 플랫폼 매트릭스 + 카테고리 · Topic 콘텐츠 추이 단일 보고서.

- [x] Q1: 3yr × 5세 × 플랫폼 베이스 매트릭스 (449 MB)
- [x] Q2: 3yr × 5세 × 카테고리 (chatbot_content_type) (495 MB)
- [x] Q3: 3yr × 5세 × Topic (508 MB)
- [x] Q4: 월별 MAU·매출 시계열 2024-01 ~ 2026-04 (3,741 MB)
- [x] 보고서 작성 — [`yoy-decline-summary-2024-2026.md`](yoy-decline-summary-2024-2026.md)
- [x] 핵심 7개 결론 도출 (TL;DR)
- [x] 5세 × Top 3 Topic 매트릭스 (연애·결혼·일반운세)
...
### Phase 9 — 2차 보고에서 도출된 신규 분석 후보

2차 보고 ([yoy-decline-summary-2024-2026.md](yoy-decline-summary-2024-2026.md)) 가 새로 제기한 질문:

- [ ] 9-1. **iOS ARPPU -21% 원인 분해** — 고가 상품 결제 감소 / 가격 인상 / OR-FGEMF-20 의 iOS 측 영향 / 결제 수단 변경. Android ARPPU 가 -6% 인 점과 대비
- [ ] 9-2. **2026 1~4월 결제 효율 단기 악화 zoom-in** — MAU 안정 (-2~6%) 인데 매출 -30~33%. 4개월 구간에서 무슨 일이?
- [ ] 9-3. **(미분류) Topic 33M 급증 (2026)** 검증 — `topic` 미태깅 신규 스킬 인지, GSheet sync 누락인지. 운영 갭 시 [ISS-006](../../common-data-airflow/docs/hellobot-data/catalog/issues.md) cross-link 또는 신규 ISS 등록
- [ ] 9-4. **자기탐구 Topic -96% 거의 소멸** 검증 — MBTI·성향 진단 류 스킬이 노후화된 건지 / topic 태깅 변경인지 / 실제 사용자 이탈인지 분해
- [ ] 9-5. **가족자녀 Topic -15% (유일하게 견고)** 근거 보강 — 36-40·41-45 중년층 결제 패턴 확인. 신규 콘텐츠 출시 효과 vs 코어 사용자 충성
- [ ] 9-6. **WEB 보강 분석** — 본 보고서는 APP-only. APP -63% 의 일부가 WEB 으로 이동했는지 (1차 EDA §8 에 4년 채널 mix 있으나 2024 기준 미보강)

## 의존 관계

- Phase 0~5 (1차 EDA) → 후속 분석 분기 결정 (완료)
- Phase 5b (2차 보고) → Phase 9 신규 분석 후보 도출 (완료)
- Phase 6 (A) · Phase 7 (B) · Phase 8 (E) · Phase 9 — **독립 진행 가능** (서로 다른 마트·이벤트 사용)
- Phase 7 (B) B-1 (`infra_android_crash` 위치 확인) → B-4 (crash 시계열) 선후 의존
- Phase 8 (E) E-1·E-2·E-3 (카탈로그 확인) → E-4 이후 쿼리 선후 의존
- Phase 9 9-3 (Topic 미분류 검증) — 운영 갭 발견 시 카탈로그 갱신 프로토콜 진입
